 ...
 * 获取手机号
 */
service.prototype.getMobile = function (app, that, detail) {
 ...
 * 不强制授权
 */
service.prototype.indexRender = function (that) {
  var self = this;
 ...
 * 继续初始渲染
 */
service.prototype.indexRenderContinue = function (that) {
  var self = this;
  wx.getLocation({
    type: 'wgs84',
 ...
 * 初始职位渲染
 */
service.prototype.indexJobRender = function (that) {
  //init
  var self = this;
 ...
 * banner list
 */
service.prototype.bannerList = function (that) {
  //init
  var self = this;
  ...
  let params = {
    ...
    version: config.version,
    sign: null,
    group_id: config.group_default
  };

  //sign
  let url = this.urlList.banner_list;
  let sign = signMd5(config.key, params);
  params.sign = sign;
 ...
 * 标签渲染
 */
service.prototype.tagsRender = function (that) {
  //init
  var self = this;
